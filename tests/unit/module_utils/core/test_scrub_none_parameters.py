...
scrub_none_test_data = [
    ...
    (
        dict(
            param1=dict(
                sub_param1='something',
                sub_param2=dict(sub_sub_param1='another_thing'),
            ),
            param2=None,
            param3=None,
            param4='something_else',
    ...
    (
        dict(
            param1=dict(sub_param1='something', sub_param2={}),
            param2=None,
            param3=None,
            param4='something_else',
        ),
    ...
    (
        dict(
            param1=[
                dict(sub_param1='my_dict_nested_in_a_list_1', sub_param2=None)
            ],
            param2=[],
        ),
        dict(
        ...
        dict(
            param1=[dict(sub_param1='my_dict_nested_in_a_list_1')], param2=[]
        ),
    ),
    (
        dict(
            param1=[
                dict(sub_param1=[dict(sub_sub_param1=None)], sub_param2=None)
            ],
            param2=[],
        ),
        dict(
